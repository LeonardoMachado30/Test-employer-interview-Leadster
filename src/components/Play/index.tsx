...
export default function Play({ closeModal }: IProp): JSX.Element {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-2xl w-full max-w-xl z-10 scale-up-center">
        <Header closeModal={closeModal} />

        <div className="bg-gray-700" style={{ height: "350px" }}>
          Video
        </div>
        <Footer />
      </div>

      <div className="absolute left-0 bottom-0 bg-white px-4 pb-3 scale-up-center">
...
const Header = ({ closeModal }: IProp) => (
  <div className="px-2">
    ...
    >
      ...
      <h2 className="text-xl font-bold max-w-xs self-center mb-6">
...
const Footer = () => (
  <div className="px-6 py-4 pb-7 bg-gray-100 text-xs rounded-b-2xl">
    <div className="flex flex-col">
      <p className="border-b-2 border-gray-200 py-3">
